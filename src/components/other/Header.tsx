      ...
      <div className="h-full w-full absolute top-0">
        <div className="container mt-10  h-full flex justify-between items-center flex-col lg:flex-row gap-16">
          <div className="flex justify-center flex-col items-start">
            <h3 className="font-semibold uppercase text-[15px] lg:text-base">
              BIENVENUE SUR LA PETITE AGORA.
            </h3>
            <h2 className="text-4xl lg:text-5xl font-bold uppercase leading-[1.512]">
              Communauté <br /> francophone
            </h2>
            <img src={svgLineVector} alt="" className="mt-4 mb-10 w-full" />
